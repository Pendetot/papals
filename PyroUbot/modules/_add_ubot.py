...
async def _(client, callback_query):
    ...
    if user_id in ubot._get_my_id:
        ...
        return await callback_query.edit_message_text(
            f"""
<blockquote> 𝚅𝚎𝚡𝚢𝙼𝚊𝚗 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 𝚄-𝙱𝙾𝚃
  ꜱᴛᴀᴛᴜꜱ : ᴘʀᴇᴍɪᴜᴍ
  ᴘʀᴇꜰɪxᴇꜱ : {prefix[0]}
...
ɪᴅ : {new_client.me.id}
ᴘʀᴇꜰɪxᴇꜱ : {' '.join(SH)}
ʜᴀʀᴀᴘ ᴊᴏɪɴ : @vexystore_support ᴜɴᴛᴜᴋ ɪɴꜰᴏ" ᴛᴇʀʙᴀʀᴜ
ᴊɪᴋᴀ ʙᴏᴛ ᴛɪᴅᴀᴋ ʀᴇꜱᴘᴏɴ, ᴋᴇᴛɪᴋ /restart</b></blockquote>
    ...
    try:
        await new_client.join_chat("vexystore_support")
        await new_client.join_chat("vexypeii03")

...
__MODULE__ = "button"
__HELP__ = """
📚 <b>--Folder Untuk Button--</b>

<blockquote><b>🚦 Perintah : <code>{0}button</code> text ~> button_text:buttonlink
🦠 Penjelasan : Untuk Membuat Tombol Inline. Jika Ingin Buat Tombol Berbaris:

.button text ~> hi:url | pe:url - pepe: url</b></blockquote>
"""

def extract_formatted_text(message):
    """ Mengambil teks dengan format seperti tebal, miring, emoji premium dari MessageEntity """
